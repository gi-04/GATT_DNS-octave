...
if ~isfield(numMethods,'metricMethod') % If unspecified, use SL4
	numMethods.metricMethod = 'SL4';
elseif isempty(numMethods.metricMethod) % If left blank, use same as spatial derivatives
...
function LHS = applyMetric(LHS,X,meshInfo,xf,method)
